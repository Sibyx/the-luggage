...
INSTANCE_NAME = os.getenv('INSTANCE_NAME', 'The Luggage')
...
WSGI_APPLICATION = 'luggage.wsgi.application'
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 1024 * 1024 * 1024 * 1  # 1GB
